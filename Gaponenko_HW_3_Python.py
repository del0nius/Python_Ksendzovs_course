...
print('Переменная item_1 меньше', comp_item) if item_1 < comp_item else print('Переменная item_1 больше или равна', comp_item)
...
print('Переменная item_2 = ', item_2) if item_2 else print('Переменная item_2 = ', item_3)
...
print('Переменная item_3 = ', item_2) if item_3 else print('Переменная item_3 = ', item_3)
...
print('Переменная item_5 = ', item_5) if item_5 else print('Переменная item_5 = ', item_4)
...
print('Переменная item_4 = ', item_5) if item_4 else print('Переменная item_4 = ', item_4)
